...
class JWT
{
    ...
    {
        if (isset($payload->exp) && Global_Functions::time() >= $payload->exp) {
    ...
    {
        if (isset($payload->nbf) && $payload->nbf > Global_Functions::time()) {
    ...
    {
        if (isset($payload->iat) && $payload->iat > Global_Functions::time()) {
            throw new BeforeValidException(
